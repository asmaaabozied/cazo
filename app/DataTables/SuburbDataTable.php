...
class SuburbDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'suburbs.datatables_actions')->editColumn('active', 'badge')
     ...
     *
     * @param \App\Models\Suburb $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Suburb $model)
    {
        return $model->select('suburbs.*');
    }
