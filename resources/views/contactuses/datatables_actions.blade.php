{!! Form::open(['route' => ['contactuses.destroy', $id], 'method' => 'delete']) !!}
<div class='btn-group'>
    <a href="{{ route('contactuses.show', $id) }}" class='btn btn-default btn-xs'>
        <span class="tooltiptext">Show</span><i class="glyphicon glyphicon-eye-open"></i>
    </a>
    {{-- <a href="{{ route('contactuses.edit', $id) }}" class='btn btn-default btn-xs'>
